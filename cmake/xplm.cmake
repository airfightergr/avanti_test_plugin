...
function(find_acfutils dir)
    ...
    set(ACFLIB "${dir}/libacfutils/${ARCH}/lib/libacfutils.a")
    
    set(ACFLIBROOT "${dir}/libacfutils/${ARCH}/lib")
    set(ACFLIBS
    ...
    set(LIBACFUTILS_INCLUDE_DIR
        "${dir}/libacfutils/include"
        "${dir}/libacfutils/${ARCH}/include"
        "${dir}/src/jsmn"
